...
/**
 * Cet evenement signale le fait metier EleveEcoleProvenanceModifiee.
 */
export class EleveEcoleProvenanceModifiee extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('EleveEcoleProvenanceModifiee', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
