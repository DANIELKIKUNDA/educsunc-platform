...
/**
 * Cet evenement signale le fait metier EleveDetacheFamille.
 */
export class EleveDetacheFamille extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('EleveDetacheFamille', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
