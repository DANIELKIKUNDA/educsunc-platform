...
/**
 * Cet evenement signale le fait metier InscriptionScolaireAnnulee.
 */
export class InscriptionScolaireAnnulee extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('InscriptionScolaireAnnulee', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
