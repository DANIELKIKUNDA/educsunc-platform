...
/**
 * Cet evenement signale le fait metier EleveReactive.
 */
export class EleveReactive extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('EleveReactive', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
