...
/**
 * Cet evenement signale le fait metier EleveDecede.
 */
export class EleveDecede extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('EleveDecede', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
