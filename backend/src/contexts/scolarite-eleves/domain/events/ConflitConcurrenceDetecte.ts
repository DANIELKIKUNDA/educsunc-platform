...
/**
 * Cet evenement signale le fait metier ConflitConcurrenceDetecte.
 */
export class ConflitConcurrenceDetecte extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('ConflitConcurrenceDetecte', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
