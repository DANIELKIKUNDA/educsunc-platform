...
/**
 * Cet evenement signale le fait metier FamilleCreee.
 */
export class FamilleCreee extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('FamilleCreee', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
