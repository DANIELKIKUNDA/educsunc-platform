...
/**
 * Cet evenement signale le fait metier ClasseAffectationChangee.
 */
export class ClasseAffectationChangee extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('ClasseAffectationChangee', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
