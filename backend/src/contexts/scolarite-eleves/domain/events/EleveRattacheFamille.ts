...
/**
 * Cet evenement signale le fait metier EleveRattacheFamille.
 */
export class EleveRattacheFamille extends BaseEvenementScolarite {
  constructor(idOrganisation: UUID, idEcole: UUID, declenchePar: UUID, public readonly referenceMetier: string, declencheLe: Instant = new Date()) {
    super('EleveRattacheFamille', idOrganisation, idEcole, declenchePar, declencheLe);
  }
}
