...
export const creerRoutesScolariteEleves = (
  ...
  serveur.get('/api/eleves/:id', (requete, reponse) => executer(requete, reponse, () => dependances.controleurEleves.consulterEleve(requete.params)));
  ...
  serveur.post('/api/eleves/:id/deces', (requete, reponse) => executer(requete, reponse, () => dependances.controleurEleves.marquerDecede(requete.params, requete.body, requete.headers)));
  ...
  serveur.get('/api/familles/:id', (requete, reponse) => executer(requete, reponse, () => dependances.controleurFamilles.consulterFamille(requete.params)));
  ...
  serveur.get('/api/familles/:id/famille-nombreuse', (requete, reponse) => executer(requete, reponse, () => dependances.controleurFamilles.evaluerFamilleNombreuse(requete.params)));
  ...
  serveur.post('/api/inscriptions-scolaires/complete', (requete, reponse) => executer(requete, reponse, () => dependances.controleurInscriptions.creerInscriptionComplete(requete.body)));
  ...
  serveur.get('/api/affectations-classes/active/:idInscription', (requete, reponse) => executer(requete, reponse, () => dependances.controleurAffectations.consulterAffectationActive(requete.params)));
  serveur.get('/api/affectations-classes/:id', (requete, reponse) => executer(requete, reponse, () => dependances.controleurAffectations.consulterAffectation(requete.params)));
  serveur.get('/api/classes-pedagogiques/:id/eleves', (requete, reponse) => executer(requete, reponse, () => dependances.controleurAffectations.listerElevesParClasse(requete.params)));
  ...
  serveur.get('/api/eleves/:id/parcours', (requete, reponse) => executer(requete, reponse, () => dependances.controleurParcours.consulterParcours(requete.params)));
  serveur.get('/api/eleves/:id/evenements', (requete, reponse) => executer(requete, reponse, () => dependances.controleurParcours.listerEvenementsParEleve(requete.params)));
  serveur.get('/api/parcours/evenements/par-annee/:idAnnee', (requete, reponse) => executer(requete, reponse, () => dependances.controleurParcours.listerEvenementsParAnnee(requete.params)));
  serveur.post('/api/eleves/:id/parcours/reconstruire', (requete, reponse) => executer(requete, reponse, () => dependances.controleurParcours.reconstruireParcours(requete.params, requete.headers)));

  serveur.get('/api/organisations/:idOrganisation/scolarite/eleves', (requete, reponse) => executer(requete, reponse, () => dependances.controleurOrganisation.listerElevesParOrganisation(requete.params, requete.query)));
  serveur.get('/api/organisations/:idOrganisation/scolarite/inscriptions', (requete, reponse) => executer(requete, reponse, () => dependances.controleurOrganisation.listerInscriptionsParOrganisation(requete.params, requete.query)));
  serveur.get('/api/organisations/:idOrganisation/scolarite/synthese', (requete, reponse) => executer(requete, reponse, () => dependances.controleurOrganisation.consulterSyntheseOrganisation(requete.params)));
  serveur.get('/api/organisations/:idOrganisation/scolarite/alertes', (requete, reponse) => executer(requete, reponse, () => dependances.controleurOrganisation.listerAlertesOrganisation(requete.params)));
};
