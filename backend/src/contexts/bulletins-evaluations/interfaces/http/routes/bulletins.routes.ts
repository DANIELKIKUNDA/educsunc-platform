...
export const creerBulletinsRoutes = (
  ...
  serveur.get('/bulletins/:idEleve/:idAnneeScolaire', (requete, reponse) =>
    executerRouteBulletin(requete, reponse, () => dependances.bulletinsController.consulter(requete.params), dependances.contexteTenant));
  serveur.get('/bulletins/:idEleve/:idAnneeScolaire/pdf', (requete, reponse) =>
    executerRouteBulletin(requete, reponse, () => dependances.bulletinsController.telechargerPdf(requete.params), dependances.contexteTenant));
  serveur.get('/bulletins/:idBulletinEleve/historique', (requete, reponse) =>
    executerRouteBulletin(requete, reponse, () => dependances.bulletinsController.consulterHistorique(requete.params), dependances.contexteTenant));
};
