...
export const creerSynthesesRoutes = (
  ...
  serveur.get('/syntheses/ecole/:idEcole/pdf', (requete, reponse) =>
    executerRouteBulletin(requete, reponse, () => dependances.syntheseResultatsController.telechargerPdf(Object.assign({}, requete.params as object, requete.query as object)), dependances.contexteTenant));
