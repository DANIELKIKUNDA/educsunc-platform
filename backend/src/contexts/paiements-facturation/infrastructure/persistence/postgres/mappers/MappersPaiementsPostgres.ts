...
import { DetteAnnuelle, type ProprietesDetteAnnuelle } from '../../../../domain/entities/DetteAnnuelle';
import { LigneDette, type ProprietesLigneDette } from '../../../../domain/entities/LigneDette';
...
export class MappersPaiementsPostgres extends BaseMapperPostgresPaiementsFacturation {
  ...
  private static depuisPersistanceMoneySimple(
    valeur: MoneyPersistance,
  ) {
    return this.versMoney(
      valeur.montant,
      valeur.devise,
      'montant',
      'devise',
