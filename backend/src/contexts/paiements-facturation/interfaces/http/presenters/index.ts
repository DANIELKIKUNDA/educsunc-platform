// Ce fichier regroupe les presenters HTTP du BC Paiements & Facturation.
export * from './PresentationHttpPaiementsFacturation';
export * from './PaiementPresenter';
export * from './DetteElevePresenter';
