...
// Cet evenement de domaine trace l'initialisation d'un programme niveau.
export class ProgrammeNiveauInitialise extends EvenementDomaine {
  ...
  constructor(idProgrammeNiveau: ProgrammeNiveauId) {
    super('ProgrammeNiveauInitialise');
