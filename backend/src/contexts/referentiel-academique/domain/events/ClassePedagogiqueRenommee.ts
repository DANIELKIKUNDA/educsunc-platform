...
// Cet evenement de domaine trace le renommage d'une classe pedagogique.
export class ClassePedagogiqueRenommee extends EvenementDomaine {
  ...
  constructor(idClassePedagogique: ClassePedagogiqueId) {
    super('ClassePedagogiqueRenommee');
