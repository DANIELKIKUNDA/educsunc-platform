...
// Cet evenement de domaine trace l'activation d'une classe pedagogique.
export class ClassePedagogiqueActivee extends EvenementDomaine {
  ...
  constructor(idClassePedagogique: ClassePedagogiqueId) {
    super('ClassePedagogiqueActivee');
