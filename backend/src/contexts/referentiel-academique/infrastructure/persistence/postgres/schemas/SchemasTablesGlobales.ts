...
export const schemaTableOrganisations: SchemaTablePostgres = creerSchemaTablePostgres({
  ...
  colonnes: [
    ...
    {
      nom: 'promoteur_principal_utilisateur_id',
      type: 'varchar',
      taille: 120,
      obligatoire: false,
      commentaire: "Identifiant utilisateur AUTH du promoteur principal rattache a l'organisation.",
    },
    {
      nom: 'promoteur_principal_nom_complet',
      type: 'varchar',
      taille: 255,
      obligatoire: false,
      commentaire: 'Nom complet affiche du promoteur principal.',
    },
    {
      nom: 'promoteur_principal_email',
      type: 'varchar',
      taille: 255,
      obligatoire: false,
      commentaire: 'Adresse email du promoteur principal.',
    },
    {
      nom: 'promoteur_principal_telephone',
      type: 'varchar',
      taille: 60,
      obligatoire: false,
      commentaire: 'Telephone du promoteur principal.',
    },
    {
      nom: 'promoteur_principal_identifiant',
      type: 'varchar',
      taille: 120,
      obligatoire: false,
      commentaire: "Identifiant metier ou alias du promoteur principal s'il existe.",
    },
...
export const schemaTableEcoles: SchemaTablePostgres = creerSchemaTablePostgres({
  ...
  colonnes: [
    ...
    {
      nom: 'province_educationnelle',
      type: 'varchar',
      taille: 255,
      obligatoire: false,
      commentaire: "Province educationnelle de reference de l'ecole.",
    },
    {
      nom: 'ville',
      type: 'varchar',
      taille: 255,
      obligatoire: false,
      commentaire: "Ville officielle de l'ecole.",
    },
    {
      nom: 'commune_ou_territoire',
      type: 'varchar',
      taille: 255,
      obligatoire: false,
      commentaire: "Commune ou territoire de l'ecole.",
    },
    ...creerColonnesCreation(true),
    ...creerColonnesModification(true),
