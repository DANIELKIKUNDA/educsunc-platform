...
export class ObtenirStatistiquesSynchronisationUseCase implements UseCase<AuditAnalyticsQuery, AuditAnalyticsOutput> {
  ...
  public async executer(entree: AuditAnalyticsQuery): Promise<AuditAnalyticsOutput> {
    return this.service.obtenirStatistiquesSynchronisation(entree);
  }
}
