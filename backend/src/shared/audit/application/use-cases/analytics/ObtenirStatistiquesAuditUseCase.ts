...
export class ObtenirStatistiquesAuditUseCase implements UseCase<AuditAnalyticsQuery, AuditAnalyticsOutput> {
  ...
  public async executer(entree: AuditAnalyticsQuery): Promise<AuditAnalyticsOutput> {
    return this.service.obtenirStatistiquesAudit(entree);
  }
}
