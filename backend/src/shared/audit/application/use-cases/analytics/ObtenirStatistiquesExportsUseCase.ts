...
export class ObtenirStatistiquesExportsUseCase implements UseCase<AuditAnalyticsQuery, AuditAnalyticsOutput> {
  ...
  public async executer(entree: AuditAnalyticsQuery): Promise<AuditAnalyticsOutput> {
    return this.service.obtenirStatistiquesExports(entree);
  }
}
