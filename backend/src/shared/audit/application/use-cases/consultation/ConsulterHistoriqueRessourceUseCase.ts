...
export class ConsulterHistoriqueRessourceUseCase implements UseCase<SearchAuditQuery, AuditSearchResultOutput> {
  ...
  public async executer(entree: SearchAuditQuery): Promise<AuditSearchResultOutput> {
    return this.service.consulterHistoriqueRessource(entree);
  }
}
