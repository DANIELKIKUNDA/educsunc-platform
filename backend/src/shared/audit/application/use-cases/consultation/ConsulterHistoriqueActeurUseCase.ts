...
export class ConsulterHistoriqueActeurUseCase implements UseCase<SearchAuditQuery, AuditSearchResultOutput> {
  ...
  public async executer(entree: SearchAuditQuery): Promise<AuditSearchResultOutput> {
    return this.service.consulterHistoriqueActeur(entree);
  }
}
