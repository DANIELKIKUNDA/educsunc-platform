...
export class LancerInvestigationForensicUseCase implements UseCase<AuditForensicQuery, AuditForensicOutput> {
  ...
  public async executer(entree: AuditForensicQuery): Promise<AuditForensicOutput> {
    return this.service.lancerInvestigation(entree);
  }
}
