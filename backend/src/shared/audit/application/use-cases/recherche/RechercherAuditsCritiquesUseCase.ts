...
export class RechercherAuditsCritiquesUseCase implements UseCase<SearchAuditQuery, AuditSearchResultOutput> {
  ...
  public async executer(entree: SearchAuditQuery): Promise<AuditSearchResultOutput> {
    return this.service.rechercherAuditsCritiques(entree);
  }
}
