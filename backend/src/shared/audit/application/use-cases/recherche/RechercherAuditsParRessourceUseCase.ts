...
export class RechercherAuditsParRessourceUseCase implements UseCase<SearchAuditQuery, AuditSearchResultOutput> {
  ...
  public async executer(entree: SearchAuditQuery): Promise<AuditSearchResultOutput> {
    return this.service.rechercherParRessource(entree);
  }
}
