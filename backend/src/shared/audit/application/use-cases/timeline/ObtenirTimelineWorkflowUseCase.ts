...
export class ObtenirTimelineWorkflowUseCase implements UseCase<AuditTimelineQuery, AuditTimelineOutput> {
  ...
  public async executer(entree: AuditTimelineQuery): Promise<AuditTimelineOutput> {
    return this.service.obtenirTimelineWorkflow(entree);
  }
}
