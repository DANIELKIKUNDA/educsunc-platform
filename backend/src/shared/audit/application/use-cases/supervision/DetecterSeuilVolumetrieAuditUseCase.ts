...
export class DetecterSeuilVolumetrieAuditUseCase implements UseCase<AuditAnalyticsQuery, AuditAnalyticsOutput> {
  ...
  public async executer(entree: AuditAnalyticsQuery): Promise<AuditAnalyticsOutput> {
    return this.service.obtenirVolumetrieAudit(entree);
  }
}
