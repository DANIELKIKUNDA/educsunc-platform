...
export const AUDIT_ACTION_MATRIX: Record<ActionAuditEnum, DefinitionActionAuditable> = {
  ...
  GOUVERNANCE_SECURITE_MODIFIEE: { action: 'GOUVERNANCE_SECURITE_MODIFIEE', typeAuditPrincipal: 'SECURITE', categoriesAudit: ['SECURITE', 'ADMINISTRATIF'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  CONFIGURATION_MODIFIEE: { action: 'CONFIGURATION_MODIFIEE', typeAuditPrincipal: 'ADMINISTRATIF', categoriesAudit: ['ADMINISTRATIF', 'SYSTEME'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  ...
  CAISSE_OUVERTE: { action: 'CAISSE_OUVERTE', typeAuditPrincipal: 'FINANCIER', categoriesAudit: ['FINANCIER', 'METIER'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  ...
  PARAMETRES_PAIEMENT_CONFIGURES: { action: 'PARAMETRES_PAIEMENT_CONFIGURES', typeAuditPrincipal: 'ADMINISTRATIF', categoriesAudit: ['ADMINISTRATIF', 'FINANCIER'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  GRILLE_TARIFICATION_CREEE: { action: 'GRILLE_TARIFICATION_CREEE', typeAuditPrincipal: 'ADMINISTRATIF', categoriesAudit: ['ADMINISTRATIF', 'FINANCIER'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  GRILLE_TARIFICATION_MODIFIEE: { action: 'GRILLE_TARIFICATION_MODIFIEE', typeAuditPrincipal: 'ADMINISTRATIF', categoriesAudit: ['ADMINISTRATIF', 'FINANCIER'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  GRILLE_TARIFICATION_DESACTIVEE: { action: 'GRILLE_TARIFICATION_DESACTIVEE', typeAuditPrincipal: 'ADMINISTRATIF', categoriesAudit: ['ADMINISTRATIF', 'FINANCIER'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  OBLIGATIONS_GENEREES: { action: 'OBLIGATIONS_GENEREES', typeAuditPrincipal: 'FINANCIER', categoriesAudit: ['FINANCIER', 'METIER'], niveauAudit: 'INFORMATION', gravitesAutorisees: ['MOYENNE'], snapshotsAutorises: true, actionSensible: true, resultatsAutorises: ['SUCCESS'] },
  ...
  EXPORT_DEMANDE: { action: 'EXPORT_DEMANDE', typeAuditPrincipal: 'EXPORT', categoriesAudit: ['EXPORT', 'CONSULTATION_SENSIBLE'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: false, actionSensible: true, resultatsAutorises: ['SUCCESS', 'FAILED'] },
  EXPORT_TELECHARGE: { action: 'EXPORT_TELECHARGE', typeAuditPrincipal: 'EXPORT', categoriesAudit: ['EXPORT', 'CONSULTATION_SENSIBLE'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: false, actionSensible: true, resultatsAutorises: ['SUCCESS', 'FAILED'] },
  ...
  REPLAY_PROJECTION_EXECUTE: { action: 'REPLAY_PROJECTION_EXECUTE', typeAuditPrincipal: 'SYSTEME', categoriesAudit: ['SYSTEME', 'ADMINISTRATIF'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: false, actionSensible: true, resultatsAutorises: ['SUCCESS', 'FAILED', 'IGNORED_DUPLICATE'] },
  ARCHIVAGE_AUDIT_EXECUTE: { action: 'ARCHIVAGE_AUDIT_EXECUTE', typeAuditPrincipal: 'CONFORMITE', categoriesAudit: ['CONFORMITE', 'ADMINISTRATIF'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: false, actionSensible: true, resultatsAutorises: ['SUCCESS', 'FAILED'] },
  VERIFICATION_INTEGRITE_EXECUTEE: { action: 'VERIFICATION_INTEGRITE_EXECUTEE', typeAuditPrincipal: 'CONFORMITE', categoriesAudit: ['CONFORMITE', 'SECURITE'], niveauAudit: 'CRITIQUE', gravitesAutorisees: ['ELEVEE'], snapshotsAutorises: false, actionSensible: true, resultatsAutorises: ['SUCCESS', 'FAILED'] },
  ANOMALIE_INTEGRITE_DETECTEE: { action: 'ANOMALIE_INTEGRITE_DETECTEE', typeAuditPrincipal: 'SECURITE', categoriesAudit: ['SECURITE', 'CONFORMITE'], niveauAudit: 'ALERTE', gravitesAutorisees: ['CRITIQUE'], snapshotsAutorises: false, actionSensible: true, resultatsAutorises: ['FAILED'] },
