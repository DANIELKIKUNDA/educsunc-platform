import type { AutorisationQualificationFinanciereElevePort } from '../../contexts/paiements-facturation/application/ports/AutorisationQualificationFinanciereElevePort';
...
export class AutorisationQualificationFinanciereEleveAdapter
  implements AutorisationQualificationFinanciereElevePort
{
  ...
  public async verifierGestionQualification(params: {
    ...
    throw new ErreurDroitsInsuffisants(
      "L'utilisateur demandeur n'est pas autorise a gerer cette qualification financiere dans ce perimetre.",
    );
  }

  public async verifierConsultationQualification(params: {
    idUtilisateur: string;
    idOrganisation: string;
    idEcole: string;
    idEleve: string;
    ...
    throw new ErreurDroitsInsuffisants(
      "L'utilisateur demandeur n'est pas autorise a consulter ces qualifications financieres dans ce perimetre.",
    );
  }
