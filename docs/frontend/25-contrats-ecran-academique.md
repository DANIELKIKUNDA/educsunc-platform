...
1. Le module `Academique` reste un module de gouvernance plateforme, pas un module local d'ecole.
2. `MANAGER_SYSTEME` reste l'acteur naturel des mutations academiques.
3. `OPERATEUR_SYSTEME` ne doit apparaitre en mutation que sur delegations explicites deja prouvees.
4. `SUPPORT_SYSTEME` ne doit pas etre reintroduit comme acteur positif des mutations academiques.
5. Les ecrans academiques doivent rester lisibles comme ecrans de referentiel et non comme ecrans pedagogiques.
