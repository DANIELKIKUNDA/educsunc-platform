...
export default defineConfig({
  testDir: '.',
  testMatch: 'platform-experience.e2e.spec.ts',
  globalSetup: require.resolve('../g1/global-setup'),
  outputDir: path.join(frontendRoot, 'artifacts', 'platform-experience-playwright-results'),
  fullyParallel: false,
  workers: 1,
  ...
  webServer: [
    {
      ...
      env: {
        ...
        EDUCSYN_REDIS_MODE: process.env.EDUCSYN_PLATFORM_EXPERIENCE_E2E_REDIS_MODE ?? 'simulation',
      },
