...
import {
  authorizedSchoolFinancialSummaryActors,
  type SchoolFinancialSummaryFilters,
...
const isAuthorized = computed(() =>
  authorizedSchoolFinancialSummaryActors.includes(session.actorCode as never),
);
...
const perimeterMessage = computed(() => {
  switch (session.actorCode) {
    ...
    case 'GESTIONNAIRE_ORGANISATION':
      return `Lecture bornee a l organisation active ${context.organizationName}, avec descente controlee vers l ecole et ses sections.`;
    default:
