  ...
  <PageContainer>
    ...
    <SectionBlock title="Outillage technique" description="Ce bloc reste reserve a l exploitation technique locale de l ecole.">
      ...
      <div class="notif-actions">
        <button class="notif-pill notif-pill--action" type="button" @click="loadDeadLetter">Dead-letter</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="runRetry">Retry</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="loadRetries">Historique retry</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="runReplay">Replay</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="loadReplayDiagnostic">Diagnostic replay</button>
      </div>
    </SectionBlock>
