  ...
  <PageContainer>
    ...
    <SectionBlock title="Filtres et pilotage" description="Le frontend relit la liste, le detail et la timeline sans inventer une logique parallele.">
      ...
      <div class="notif-actions">
        <button class="notif-pill notif-pill--action" type="button" @click="loadList">Lister</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="loadDetail">Detail</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="loadTimeline">Timeline</button>
        <button class="notif-pill" type="button" @click="loadMonitoring">Monitoring</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="acknowledge">Accuser reception</button>
        <button class="notif-pill" type="button" :disabled="!notificationId" @click="escalate">Escalader</button>
      </div>
    </SectionBlock>
