  ...
  <PageContainer>
    ...
    <SectionBlock title="Publication de test" description="Cette vue ne remplace pas un moteur temps reel final; elle projette l'outillage preparatoire reel.">
      ...
      <div class="notif-actions">
        <button class="notif-pill" type="button" @click="loadCapabilities">Relire capacites</button>
        <button class="notif-pill notif-pill--action" type="button" @click="publishTest">Publier test</button>
      </div>
    </SectionBlock>
