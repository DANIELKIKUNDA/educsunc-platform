...
function construireEntetesContexte(contexte: NotificationApiContext): Record<string, string> {
  if (
    ...
    throw new Error(
      'Le contexte frontend notifications est incomplet. Configurez VITE_REFERENTIEL_ORGANISATION_ID, VITE_REFERENTIEL_ECOLE_ID et VITE_REFERENTIEL_UTILISATEUR_ID.',
    );
  }
